"""Tests for Gemini SessionManager."""

from datetime import datetime, timedelta

import pytest

from plugins.gemini.session_manager import GeminiSession, SessionManager


class TestGeminiSession:
    """Tests for the GeminiSession dataclass."""
...
class TestSessionManagerGetOrCreate:
    ...
    def test_max_sessions_reclaims_expired(self):
        ...
        mgr.get_or_create(None, "a2")
        # Third should reclaim the expired one (s1)
...
class TestSessionManagerAppendTurn:
    ...
    def test_sliding_window(self):
        ...
        assert history[0]["parts"][0]["text"] == "msg-5"
        assert history[-1]["parts"][0]["text"] == "msg-9"

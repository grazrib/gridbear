"""Image plugin admin routes — unified provider management."""
...
@router.get("/", response_class=HTMLResponse)
async def image_config_page(request: Request, _: bool = Depends(require_login)):
    """Unified image provider configuration page."""
...
async def save_base_config(
    ...
    # Read current config and update only base plugin fields
    new_config = {}

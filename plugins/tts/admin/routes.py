"""TTS plugin admin routes — unified provider management."""
...
@router.get("/", response_class=HTMLResponse)
async def tts_config_page(request: Request, _: bool = Depends(require_login)):
    """Unified TTS provider configuration page."""
